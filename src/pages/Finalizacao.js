...
import FinalizacaoForm from '../components/FinalizacaoForm'
...
class Finalizacao extends React.Component {
  ...
  getStepContent = (step, card) => {
    switch (step) {
      case 0:
        return <FinalizacaoForm onChangeField={this.onChangeField} card={card} />
      case 1:
...
export default withUser(withStyles(styles)(Finalizacao))
